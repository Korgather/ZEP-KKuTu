...
exports.turnStart = function () {
	...
	my.game.hintTimer = setTimeout(function () {
		turnHint.call(my);
	}, my.game.roundTime * 0.2);
	my.game.hintTimer2 = setTimeout(function () {
		turnHint.call(my);
	}, my.game.roundTime * 0.4);
	my.game.hintTimer3 = setTimeout(function () {
		turnHint.call(my);
	}, my.game.roundTime * 0.6);
	my.game.hintTimer4 = setTimeout(function () {
		turnHint.call(my);
	}, my.game.roundTime * 0.8);
...
exports.submit = function (client, text) {
	...
	if (my.game.winner.indexOf(client.id) == -1 && text == $ans._id && play && !gu) {
