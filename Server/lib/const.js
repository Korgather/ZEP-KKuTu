...
exports.CATEGORIES = ["all", "body", "skin", "badge", "head", "eye", "mouth", "clothes", "hs", "back"];
exports.AVAIL_EQUIP = ["NIK", "BDG1", "BDG2", "BDG3", "BDG4", "Mhead", "Meye", "Mmouth", "Mhand", "Mclothes", "Mshoes", "Mback", "Mbody"];
exports.GROUPS = {
...
*/
	...
	ETY: { lang: "en", rule: "Typing", opts: ["prv"], time: 1, ai: false, big: false, ewq: false },
	KAP: { lang: "ko", rule: "Classic", opts: ["man", "ext", "mis", "loa", "str"], time: 1, ai: true, big: false, _back: true, ewq: true },
	HUN: { lang: "ko", rule: "Hunmin", opts: ["ext", "mis", "loa", "str"], time: 1, ai: true, big: false, ewq: true },
	KDA: { lang: "ko", rule: "Daneo", opts: ["ijp", "mis"], time: 1, ai: true, big: false, ewq: true },
	EDA: { lang: "en", rule: "Daneo", opts: ["ijp", "mis"], time: 1, ai: true, big: false, ewq: true },
	KSS: { lang: "ko", rule: "Sock", opts: ["no2"], time: 1, ai: false, big: true, ewq: false },
	ESS: { lang: "en", rule: "Sock", opts: ["no2"], time: 1, ai: false, big: true, ewq: false },
	KDG: { lang: "ko", rule: "Drawing", opts: ["ijp", "sht", "ulm"], time: 1, ai: false, big: true, ewq: true },
	EDG: { lang: "en", rule: "Drawing", opts: ["ijp", "sht", "ulm"], time: 1, ai: false, big: true, ewq: true },
};
...
exports.EN_INJEONG = ["LOL"];
exports.KO_THEME = ["30", "40", "60", "80", "90", "140", "150", "160", "170", "190", "220", "230", "240", "270", "310", "320", "350", "360", "420", "430", "450", "490", "530", "1001"];
exports.EN_THEME = ["e05", "e08", "e12", "e13", "e15", "e18", "e20", "e43"];
...
exports.KOR_GROUP = new RegExp("(,|^)(" + ["0", "1", "3", "7", "8", "11", "9", "16", "15", "17", "2", "18", "20", "26", "19", "INJEONG"].join("|") + ")(,|$)");
